// timestamp: Tue, 26 Jun 2007 18:02:32
...
var StateTransition=Base.extend({
  constructor: function(pattern, replacement, nextState, currentState, context) {
    ...
    this.replacement=typeof replacement=="function" ? bind(context, replacement) : replacement;
